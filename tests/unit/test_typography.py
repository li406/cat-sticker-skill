...
from cat_sticker_skill.typography.meme_yellow import compose_meme_yellow
...
def test_compose_creates_output(tmp_path):
    ...
    compose_meme_yellow(input_path, output_path, "测试文字")
...
def test_text_is_visible(tmp_path):
    ...
    output_path = tmp_path / "output.png"
    compose_meme_yellow(input_path, output_path, "你好")
